...
<?php //echo set_breadcrumb( '', '', array(     'replacer' =>array (        'aluas'   => '','materia'    => '' ) ) ); ?> 
		...
		<ul class="<?php  if($this->uri->segment(2) == "") echo "current" ; else echo "select" ;?>"><li class="sub_show" ><a href="<?php echo base_url();?>admin"><b>Dashboard</b></a>
		...
		<ul class="<?php  if($this->uri->segment(2) == "master") echo "current" ; else echo "select" ;?>  dropdown"><li><a href="#nogo"><b>Master Head</b></a>
		...
		<div class="select_sub show">
			...
			<ul class="sub">
				...
				<li class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"  ><a href="<?php echo base_url(); ?>admin/master" >Add City </a></li>
				<li class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"  ><a href="<?php echo base_url(); ?>admin/master/citylist" >All Cities </a></li>
								

				<li class="<?php $murl=@trim($url[1]); if($murl=='addarea'){ echo "sub_show";} ?>"  ><a href="<?php echo base_url();?>admin/master/addarea">Add Area / Sector Master</a></li>				
<li class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"  ><a href="<?php echo base_url(); ?>admin/master/arealist" >All Area  </a></li>
...
<li class="<?php //$murl=@trim($url[1]); if($murl=='addsociety'){ echo "sub_show";} ?>"  ><a href="<?php // echo base_url();?>admin/society_user/add">Add Society Admin</a></li>	
		...
		<ul class="<?php  if($this->uri->segment(2) == "allsociety") echo "current" ; else echo "select" ;?> dropdown"><li><a href="#nogo"><b>Society</b></a>
...
<li class="<?php $murl=@trim($url[1]); if($murl=='addsociety'){ echo "sub_show";} ?>"  ><a href="<?php echo base_url();?>admin/allsociety/addsociety">Add New Society</a></li>	
		...
		<ul class="<?php  if($this->uri->segment(2) == "allusers" || $this->uri->segment(2) =='allpropertys') echo "current" ; else echo "select" ;?> dropdown"><li><a href="#nogo"><b>Sub Admin</b></a>
		...
		<div class="select_sub show">
			...
			<ul class="sub">
				...
				<li><a class="<?php $murl=@trim($url[0]);  $murl_1=@trim($url[1]);  if($murl=='allusers' && $murl_1==''){ echo "sub_show" ;} ?>"   href="<?php echo base_url();  ?>admin/allusers" >View All Sub Admins</a></li>
...
<!--		
		...
		<ul class="<?php  if($this->uri->segment(2) == "customers") echo "current" ; else echo "select" ;?> dropdown"><li><a href="#nogo"><b>Customer</b></a>

		<div class="select_sub show">

			<ul class="sub">
			<li class="<?php $murl=@trim($url[1]); if($murl=='addsociety'){ echo "sub_show";} ?>"  ><a href="<?php echo base_url();?>admin/customers/add">Add Customer</a></li>
				<li class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"  ><a href="<?php echo base_url();?>admin/customers" >View all Customers</a></li>
		...
		<ul class="<?php  if($this->uri->segment(2) == "allcmspages") echo "current" ; else echo "select" ;?> dropdown"><li><a href="#nogo"><b>Static Pages</b></a>
		...
		<ul class="<?php  if($this->uri->segment(2) == "allfaq") echo "current" ; else echo "select" ;?>  dropdown">
		<li><a href="#nogo"><b>FAQS</b></a>

		<div class="select_sub show">

			<ul class="sub">
<li><a class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"  href="<?php echo base_url();?>admin/allfaq/addfaq" >Add New FAQ</a></li>
				<li><a class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"  href="<?php echo base_url() ; ?>admin/allfaq">View All FAQS</a></li>
	...
	<ul class="select <?php  if($this->uri->segment(2) == "") echo "current" ; else echo "select" ;?>"><li class="sub_show" ><a href="<?php echo base_url();?>admin/login/dashboard"><b>Dashboard</b></a>
		...
		<ul class="select <?php  if($this->uri->segment(2) == "allsociety") echo "current" ; else echo "select" ;?>  dropdown"><li><a href="#nogo"><b>Society</b></a>
		<div class="select_sub show">
...
<li><a class="<?php $murl=@trim($url[0]);  $murl_1=@trim($url[1]);  if($murl=='allusers' && $murl_1==''){ echo "sub_show" ;} ?>"   href="<?php echo base_url();  ?>admin/allusers" >View all Customers</a></li>                
		...
		<ul class="select <?php  if($this->uri->segment(2) == "allpropertys") echo "current" ; else echo "select" ;?> dropdown"><li><a href="#nogo"><b>Property</b></a>
	...
	<ul class="select <?php  if($this->uri->segment(2) == "") echo "current" ; else echo "select" ;?>"><li class="sub_show" ><a href="<?php echo base_url();?>admin/login/dashboard"><b>Dashboard</b></a>
		...
		<ul class="select <?php  if($this->uri->segment(2) == "allsociety") echo "current" ; else echo "select" ;?> dropdown"><li><a href="#nogo"><b>Customers</b></a>
		<div class="select_sub show">

			<ul class="sub">               

<li><a class="<?php $murl=@trim($url[0]);  $murl_1=@trim($url[1]);  if($murl=='allusers' && $murl_1==''){ echo "sub_show" ;} ?>"   href="<?php echo base_url();  ?>admin/allusers" >View Your Customers</a></li>                
		...
		<ul class="select <?php  if($this->uri->segment(2) == "society_property") echo "current" ; else echo "select" ;?> dropdown"><li><a href="#nogo"><b>Property</b></a>
...
<li><a class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"   href="<?php echo base_url();?>admin/society_property/add" >Add New property</a></li>

				<li><a class="<?php $murl=@trim($url[1]); if($murl==''){ echo "sub_show";} ?>"   href="<?php echo base_url();?>admin/society_property" >View All properties</a></li>
